...
public class DTOGenerator extends Generator{
	...
	public DTOGenerator(String packageName,String entityPackageName, Table table) {
		super();
	...
	public String generateCode() {
		...
		if(StringUtils.isNotEmpty(entityPackageName)){
			sb.append("import "+entityPackageName+"."+clazzName+";\r\n");
		}else{
		...
		fileName = clazzName+dto+".java";
		if(StringUtils.isNotEmpty(entityPackageName)){
			sb.append("public class "+clazzName+dto +" extends "+clazzName+"{\r\n");
		}else{
			sb.append("public class "+clazzName+dto +" implements Serializable{\r\n");
			try {
				Thread.sleep(100);
			...
			sb.append("\t\t"+clazzName+dto+" other = ("+clazzName+dto+")obj;\r\n");
