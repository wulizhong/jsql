...
public class FieldNameUtils {
	...
	public static String convertToSetMethodName(String dbFieldName,boolean lowerHump) {
		
		String javaFieldName = underlineToHump(dbFieldName,lowerHump);
		
		return "set"+toUpperCaseFirstOne(javaFieldName);
	}
}
